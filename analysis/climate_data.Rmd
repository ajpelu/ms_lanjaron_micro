...
ggsave(plot = d2s120Arquilla, 
       filename = here::here("output/arquilla120.jpg"), 
       height = 10, width = 9, units = "cm",
       dpi = 600, device = "jpeg")

ggsave(plot = d2s120Arquilla, 
       filename = here::here("output/arquilla120.tiff"), 
       height = 10, width = 9, units = "cm",
       dpi = 300, device = "tiff")

ggsave(plot = d2s120Arquilla, 
       filename = here::here("output/arquilla120.png"), 
       height = 10, width = 9, units = "cm",
       dpi = 600, device = "png")
...
ggsave(plot = combined_plot, 
       filename = here::here("output/cumulative.tiff"), 
       height = 18, width = 18, units = "cm",
       dpi = 300, device = "tiff")

ggsave(plot = combined_plot, 
       filename = here::here("output/cumulative.png"), 
       height = 18, width = 18, units = "cm",
       dpi = 600, device = "png")
